                ...
                <div class="main-content-inner">
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-8">
                            <div class="card">
                                <div class="container">
                                    <h2>Danh sách Đơn Hàng <span style="color: red"><?php if(isset($_SESSION['mesage'])){echo $_SESSION['mesage'];unset($_SESSION['mesage']);} ?></span></h2>
                                    <p></p>            
                                    <table id="dataTable" class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Địa chỉ</th>
                                                <th>Tổng</th>
                                                <th>Tình trang giao hàng</th>
                                                <th>Thao tác</th>
                                            </tr>
                                        </thead>
                                        
                                        <tbody>
                                            <?php $stt=0;$tong=0; while($row=$listdh->fetch_assoc()){$stt++; ?>
                                                
                                            <tr>
                                                <?php $tong=$tong+($row['gia_ban']*$row['soluong']); ?>
                                                <td><?php echo $stt ?></td>
                                                ...
                                                <td><?php echo date_format(date_create($row['ngaydathang']),"d-m-Y") ?></td>
                                                <td><?php echo $row['diachi_kh'] ?></td>
                                                <td><?php echo number_format(($row['gia_ban']*$row['soluong'])) ?></td>
                                                <td>
                                                    <?php 
                                                        ...
                                                        elseif($row['tinhtranggiaohang']==3){
                                                            echo "Đã giao";
                                                        }
                                                     ?>
                                                </td>
                        ...
                        <div class="card">
                            <div class="card-body pb-0">
                                ...
                                <h6>Tổng tiền đơn hàng: <span style="color: red"><?php echo number_format($tong) ?> ₫</span></h6><br>
                                <h6>Số đơn hàng: <?php echo $listdh->num_rows; ?></h6><br>
