                ...
                <div class="main-content-inner">
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-8">
                            <div class="card">
                                <div class="container">
                                    <h2>Danh sách tác giả <span style="color: red"><?php if(isset($_SESSION['mesage'])){echo $_SESSION['mesage'];unset($_SESSION['mesage']);} ?></span></h2>
                                    <p></p>            
                                    <table id="dataTable" class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php while($row = $listtg->fetch_assoc()){ ?>
                                                
                                                <tr>
                                                    <td><?php echo $row['ma_tg'] ?></td>
                                                    <td><?php echo $row['ten_tg'] ?></td>
                                                    <td><?php echo $row['diachi_tg'] ?></td>
                                                    <td><?php echo $row['tieusu'] ?></td>
                                                    <td><?php echo $row['sdt_tg'] ?></td> 
                                                    <td><a href="admin.php?id=<?php echo $row['ma_tg'] ?>&action=edittg">Sửa</a> | <a onclick="return confirm('Xóa toàn bộ thông tin có liên quan')" href="admin.php?id=<?php echo $row['ma_tg'] ?>&action=deletetg">Xóa</a></td> 
                                                </tr>
                        ...
                        <div class="col-lg-3 mt-5">
                            <div class="card">
                                <div class="card-body pb-0">
                                    ...
                                    <h6>Số lượng tác giả: <a href="index.php"><?php echo $listtg->num_rows ?></a></h6><br>
